...
contract pHackpot is VRFConsumerBaseV2Plus, AutomationCompatibleInterface {
    ...
    event betPlaced(address player, uint256 amount,uint256 nthGame);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function selectWinner() public MisExecutingSelectWinner {
        ...
        nthGame++;
        emit winnerSelected(winner, totalBets, nthGame);
        lastPrize = totalBets;

    }
    event winnerSelected(address winner, uint256 totalBets, uint256 nthGame);
    ...
    function betTokens(
        ...
        totalBets += amount;
        emit betPlaced(msg.sender, amount, nthGame);
